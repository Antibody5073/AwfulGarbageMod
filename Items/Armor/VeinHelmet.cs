...
namespace AwfulGarbageMod.Items.Armor
{
	...
	public class VeinHelmet : ModItem
	{
		public override void SetStaticDefaults() {
            // DisplayName.SetDefault("Vein Mask");
        ...
        public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<VeinBreastplate>() && legs.type == ModContent.ItemType<VeinLeggings>();
		}

        // UpdateArmorSet allows you to give set bonuses to the armor.
        public override void UpdateArmorSet(Player player)
        {
            player.setBonus = "Minions striking an enemy will burst blood\nupwards dealing damage equal to 1/2 of the damage.\nHas a cooldown of 3 seconds"; // This is the setbonus tooltip
            player.GetModPlayer<GlobalPlayer>().VeinBonus = true;
        }
