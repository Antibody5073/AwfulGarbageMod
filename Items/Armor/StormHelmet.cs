...
namespace AwfulGarbageMod.Items.Armor
{
	...
	public class StormHelmet : ModItem
    {
		public override void SetStaticDefaults() {
            // DisplayName.SetDefault("Storm Helmet");
        ...
        {
            player.setBonus = "Every 5th bow shot also shoots a few Electric Arrows from the sky\nLightning Burst will always do this at max charge\n4 defense"; // This is the setbonus tooltip
            player.GetModPlayer<GlobalPlayer>().StormHelmetBonus = true;
