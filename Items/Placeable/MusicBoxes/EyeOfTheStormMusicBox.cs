using AwfulGarbageMod.Tiles.MusicBoxes;
using Terraria.ID;
using Terraria.ModLoader;

namespace AwfulGarbageMod.Items.Placeable.MusicBoxes
{
    public class EyeOfTheStormMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/EotSTheme"), ModContent.ItemType<EyeOfTheStormMusicBox>(), ModContent.TileType<EyeOfTheStormMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<EyeOfTheStormMusicBoxTile>(), 0);
        }
    }
}