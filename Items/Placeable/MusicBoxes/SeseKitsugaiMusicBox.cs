...
{
    public class SeseKitsugaiMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SeseTheme"), ModContent.ItemType<SeseKitsugaiMusicBox>(), ModContent.TileType<SeseKitsugaiMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<SeseKitsugaiMusicBoxTile>(), 0);
        }
    }
}