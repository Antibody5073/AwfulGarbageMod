...
{
    public class HarujionLocator : ModItem
    {
        ...
        {
            int proj = Projectile.NewProjectile(Projectile.GetSource_NaturalSpawn(), player.Center, new Vector2(0, 0), Mod.Find<ModProjectile>("HarujionLocatorProj").Type, 0, 0, player.whoAmI);
        }
    }

    public class HarujionLocatorProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            Vector2 IcePalacePos = new Point16(Structures.HarujionPosX, Structures.HarujionPosY).ToWorldCoordinates();
