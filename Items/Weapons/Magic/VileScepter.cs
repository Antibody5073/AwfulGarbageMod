...
namespace AwfulGarbageMod.Items.Weapons.Magic
{
    ...
    public class VileScepterBuff : ScepterBuff
    {
        public override int ScepterMaxManaPenalty => 25;
        public override int NonMagicDmgPenaltyPercent => 10;
        public override int ScepterProjType => ModContent.ProjectileType<VileScepterOrbit>();
    ...
    public class VileScepter : ModItem
	{
        ...
        public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = Mod.Find<ModProjectile>("VileScepterOrbit").Type;
			Item.shootSpeed = 0f;
			Item.noMelee = true;
            Item.buffType = ModContent.BuffType<VileScepterBuff>();
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (player.ownedProjectileCounts[Mod.Find<ModProjectile>("VileScepterOrbit").Type] < ModItemSets.Sets.MaxScepterProjectiles[Item.type] + player.GetModPlayer<GlobalPlayer>().MaxScepterBoost)
            {
                var projectile = Projectile.NewProjectileDirect(source, position, velocity, type, Item.damage, knockback, Main.myPlayer, player.ownedProjectileCounts[Mod.Find<ModProjectile>("VileScepterOrbit").Type]);
            }
    ...
    public class VileScepterOrbit : ScepterOrbit
    {
        public override void SetStaticDefaults()
        {
        ...
        public override float OrbitDistance => 160;
        public override float OrbitSpd => 0.7f;
        public override float OffsetDir => 0;
        public override int ProjType => ModContent.ProjectileType<VileScepterProj>();
    ...
    public class VileScepterProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
