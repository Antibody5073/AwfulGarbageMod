...
namespace AwfulGarbageMod.Items.Weapons.Melee
{
    public class CobaltFlail : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 44; // The damage of your flail, this is dynamically adjusted in the projectile code.
            Item.noUseGraphic = true; // This makes sure the item does not get shown when the player swings his hand
            Item.shoot = ModContent.ProjectileType<CobaltFlailProj>(); // The flail projectile
    ...
    public class CobaltFlailProj : BaseFlailProjectile
    {
        public override string ChainTexturePath()
        {
            return "AwfulGarbageMod/Items/Weapons/Melee/CobaltFlailProjectileChain";
        }
        public override void SetStaticDefaults()
        {
        ...
        public override float MaxSpinDistance => 125;
        public override float SpinSpd => 2.3f;
        ...
        {
            int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Cobalt, 0f, 0f, 0, default(Color), 1f);
