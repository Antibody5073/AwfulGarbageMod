...
{
    public class DoubleWhammy : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<DoubleWhammyProj>(); // The flail projectile
    ...
    public class DoubleWhammyProj : BaseFlailProjectile
    {
        public override string ChainTexturePath()
        {
            return "AwfulGarbageMod/Items/Weapons/Melee/DoubleWhammyProjectileChain"; 
        }
        public override void SetStaticDefaults()
        {
        ...
        public override float MaxSpinDistance => 100;
        public override float SpinSpd => 0.8f;
        public override float SpinDistanceIncrease => 0.25f;
