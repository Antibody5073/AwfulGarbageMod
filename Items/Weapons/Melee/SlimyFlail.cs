...
{
    public class SlimyFlail : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<SlimyFlailProj>(); // The flail projectile
    ...
    public class SlimyFlailProj : BaseFlailProjectile
    {
        public override string ChainTexturePath()
        {
            return "AwfulGarbageMod/Items/Weapons/Melee/SlimyFlailProjectileChain"; 
        }
        public override void SetStaticDefaults()
        {
