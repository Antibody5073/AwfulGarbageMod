...
namespace AwfulGarbageMod.Items.Weapons.Melee
{
    ...
    public class SoulSpear : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.rare = 1;
			Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<SoulSpearProj>();
            Item.shootSpeed = 10f;
		}
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (counter % 3 == 0)
            {
                int proj = Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<SoulSpearProjSoul>(), damage * 2, 0, player.whoAmI, 0);
            }
            return true;
        }
    ...
    public class SoulSpearProjSoul : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            for (int i = 0; i < 4; i++)
            {
                int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.DungeonSpirit, 0, 0, 0, default(Color), 1f);
            ...
            else
            {
                ...
                if (Vector2.Distance(new Vector2(0, 0), Projectile.velocity) > 13f)
                {
    ...
    public class SoulSpearProj : ModProjectile
    {
        ...
        protected virtual float HoldoutRangeMax => 184f;
