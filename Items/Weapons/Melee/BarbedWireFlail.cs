...
{
    public class BarbedWireFlail : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BarbedWireFlailProj>(); // The flail projectile
    ...
    public class BarbedWireFlailProj : BaseFlailProjectile
    {
        public override string ChainTexturePath()
        {
            return "AwfulGarbageMod/Items/Weapons/Melee/BarbedWireFlailProjectileChain"; 
        }
        public override void SetStaticDefaults()
        {
        ...
        public override void SpinEffect(Player player, float timer, float length, float maxLength)
        {
            ...
            {
                linkedProjectile = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<PyrochainProjHitbox>(), (int)(Projectile.damage / 3), Projectile.knockBack / 3, player.whoAmI);
    ...
    public class BarbedWireFlailProjHitbox : ModProjectile
    {
        public override void SetStaticDefaults()
        {
