...
namespace AwfulGarbageMod.Items.Weapons.Ranged
{
    ...
    public class BagOfFrozenPoisonedKnives : ModItem
	{
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            int proj = Projectile.NewProjectile(source, position, velocity.RotatedByRandom(MathHelper.ToRadians(4)), Mod.Find<ModProjectile>("BagOfFrozenPoisonedKnivesProj").Type, damage, knockback, player.whoAmI);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(Mod.Find<ModItem>("BagOfPoisonedKnives").Type);
            recipe.AddIngredient(Mod.Find<ModItem>("BagOfFrozenKnives").Type);
            recipe.AddIngredient(ItemID.JungleSpores, 13);
            recipe.AddIngredient(Mod.Find<ModItem>("FrostShard").Type, 7);
            recipe.AddIngredient(ItemID.ShadowScale, 5);
            recipe.AddTile(TileID.Anvils);
            recipe.Register();
            Recipe recipe2 = CreateRecipe();
            recipe2.AddIngredient(Mod.Find<ModItem>("BagOfPoisonedKnives").Type);
            recipe2.AddIngredient(Mod.Find<ModItem>("BagOfFrozenKnives").Type);
            recipe2.AddIngredient(ItemID.JungleSpores, 13);
            recipe2.AddIngredient(Mod.Find<ModItem>("FrostShard").Type, 7);
    ...
    public class BagOfFrozenPoisonedKnivesProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            if (Projectile.timeLeft % 3 == 0)
            {
                ...
                {
                    dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Poisoned, 0f, 0f, 0, default(Color), 1f);
                }
