...
namespace AwfulGarbageMod.Items.Weapons.Ranged
{
    ...
    public class FrigidiumKnives : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = Mod.Find<ModProjectile>("FrigidiumKnivesProj").Type;
            Item.shootSpeed = 6f;
        }
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            int proj = Projectile.NewProjectile(source, position, velocity * 1.3f, type, damage, knockback, player.whoAmI);
            Main.projectile[proj].scale *= 1.2f;
            Main.projectile[proj].penetrate += 2;
            proj = Projectile.NewProjectile(source, position, velocity.RotatedBy(MathHelper.ToRadians(12)), type, damage, knockback, player.whoAmI);
            proj = Projectile.NewProjectile(source, position, velocity.RotatedBy(MathHelper.ToRadians(-12)), type, damage, knockback, player.whoAmI);
            return false;
        }
    ...
    public class FrigidiumKnivesProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
