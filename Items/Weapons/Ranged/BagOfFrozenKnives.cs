...
namespace AwfulGarbageMod.Items.Weapons.Ranged
{
    ...
    public class BagOfFrozenKnives : ModItem
	{
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            int proj = Projectile.NewProjectile(source, position, velocity.RotatedByRandom(MathHelper.ToRadians(3)), Mod.Find<ModProjectile>("BagOfFrozenKnivesProj").Type, damage, knockback, player.whoAmI);

            return false;
        }
    }

    public class BagOfFrozenKnivesProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
