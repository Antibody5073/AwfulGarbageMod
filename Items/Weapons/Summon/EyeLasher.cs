...
{
    public class EyeLasher : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ModContent.ProjectileType<EyeLasherProj>(), 2, 2.5f, 10);
            Item.useTime = 9;
            Item.useAnimation = 9;
            Item.rare = 2;
            Item.autoReuse = true;
        ...
        {
            int proj = Projectile.NewProjectile(source, position, velocity, Item.shoot, damage, knockback, player.whoAmI);
            return true;
        }
    ...
    public class EyeLasherProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            target.AddBuff(ModContent.BuffType<EyeLasherBuff>(), 240);
