...
namespace AwfulGarbageMod.Items.Weapons.Summon
{
    public class BloodChain : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ModContent.ProjectileType<BloodChainProj>(), 18, 2.5f, 6f);
            Item.useTime = 30;
    ...
    public class BloodChainProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            target.AddBuff(ModContent.BuffType<BloodChainBuff>(), 240);
