...
namespace AwfulGarbageMod.Items.Weapons.Summon
{
    ...
    public class IceSpiritStaffMinionBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<IceSpiritStaffMinion>()] > 0)
            {
    ...
    public class IceSpiritStaff : ModItem
	{
		public override void SetStaticDefaults()
		{
		...
		public override void SetDefaults()
		{
            ...
            Item.buffType = ModContent.BuffType<IceSpiritStaffMinionBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<IceSpiritStaffMinion>(); // This item creates the minion projectile
        }
    ...
    public class IceSpiritStaffMinion : ModProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<IceSpiritStaffMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<IceSpiritStaffMinionBuff>()))
            {
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, NPC target, float distanceToIdlePosition, Vector2 vectorToIdlePosition)
        {
            ...
            if (foundTarget)
            {
                ...
                if (atkTimer % 8 == 0)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center + Main.rand.NextVector2Circular(12, 12), direction * 16f, ModContent.ProjectileType<IceSpiritStaffProjectile>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                }
                Vector2 targetPos = targetCenter;
                speed = Vector2.Distance(Projectile.Center, targetPos) / 2.5f - 48;
    ...
    public class IceSpiritStaffProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.SummonTagDamageMultiplier[Projectile.type] = 0.8f;
        }
