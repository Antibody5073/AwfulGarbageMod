...
namespace AwfulGarbageMod.Items.Weapons.Summon
{
    ...
    public class VerdantStaffMinionBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<VerdantStaffMinion>()] > 0)
            {
    ...
    public class VerdantStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            Item.buffType = ModContent.BuffType<VerdantStaffMinionBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<VerdantStaffMinion>(); // This item creates the minion projectile
        }
    ...
    public class VerdantStaffMinion : ModProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<VerdantStaffMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<VerdantStaffMinionBuff>()))
            {
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, NPC target, float distanceToIdlePosition, Vector2 vectorToIdlePosition)
        {
            ...
            if (foundTarget)
            {
                ...
                {
                    shotnum++;
                    int homing = shotnum % 3 == 0 ? 7 : 0;
                    Projectile.frame = 1;
                    Projectile.frameCounter = 0;
                    direction = targetCenter - Projectile.Center;
                    direction.Normalize();
                    int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, direction * 7f, ModContent.ProjectileType<VerdantStaffProjectile>(), Projectile.damage, Projectile.knockBack, Projectile.owner, homing);
                }
    ...
    public class VerdantStaffProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
