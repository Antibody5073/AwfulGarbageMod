...
{
    public class CloudChain : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ModContent.ProjectileType<CloudChainProj>(), 18, 2, 6.5f);
            Item.useTime = 28;
    ...
    public class CloudChainProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            target.AddBuff(ModContent.BuffType<CloudChainBuff>(), 240);
