...
namespace AwfulGarbageMod.Items.Weapons.Summon
{
    ...
    public class CloudBangasaMinionBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<CloudBangasaMinion>()] > 0)
            {
    ...
    public class CloudBangasa : ModItem
	{
		public override void SetStaticDefaults()
		{
		...
		public override void SetDefaults()
		{
            ...
            Item.buffType = ModContent.BuffType<CloudBangasaMinionBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<CloudBangasaMinion>(); // This item creates the minion projectile
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe3.AddIngredient(ItemID.PlatinumBar, 5); 
            recipe3.AddIngredient(ItemID.Silk, 8);
            ...
            recipe4.AddIngredient(ItemID.Silk, 8);
    ...
    public class CloudBangasaMinion : ModProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<CloudBangasaMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<CloudBangasaMinionBuff>()))
            {
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, float distanceToIdlePosition, Vector2 vectorToIdlePosition, float prediction)
        {
            ...
            if (foundTarget)
            {
                ...
                if (atkTimer % 25 == 0)
                {
                    int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center + new Vector2(Main.rand.NextFloat(-10, 10), 0), new Vector2(0, 5), Mod.Find<ModProjectile>("CloudBangasaProj").Type, Projectile.damage, Projectile.knockBack, Projectile.owner);
                    Main.projectile[proj].ArmorPenetration += 5;
                }
                speed = Vector2.Distance(Projectile.Center, targetCenter) / 12f;
                if (speed > 12)
                {
                    speed = 12;
                }
    ...
    public class CloudBangasaProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
