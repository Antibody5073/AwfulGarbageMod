...
{
    public class HorseSnapper : ModItem
    {
    ...
    public class HorseSnapperProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        {
            target.AddBuff(ModContent.BuffType<HorseSnapperBuff>(), 240);
            Main.player[Projectile.owner].AddBuff(ModContent.BuffType<HorseSnapperBuff>(), 240);
