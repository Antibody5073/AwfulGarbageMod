...
namespace AwfulGarbageMod.Items.Weapons.Paladin
{
    ...
    public class Icebreaker2 : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Icebreaker2Proj>(); // The flail projectile
    ...
    public class Icebreaker2Proj : Melee.BaseFlailProjectile
    {
        public override string ChainTexturePath()
        {
            return "AwfulGarbageMod/Items/Weapons/Paladin/Icebreaker2ProjectileChain";
        }
        public override void SetStaticDefaults()
        {
