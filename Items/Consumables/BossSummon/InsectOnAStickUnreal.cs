...
namespace AwfulGarbageMod.Items.Consumables.BossSummon
{
    ...
    public class InsectOnAStickUnreal : ModItem
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("AwfulGarbageMod/Items/Consumables/BossSummon/InsectOnAStickUnreal").Value;
            for (int i = 0; i < 4; i++)
            {
