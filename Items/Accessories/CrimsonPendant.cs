...
namespace AwfulGarbageMod.Items.Accessories
{
    ...
    public class CrimsonPendant : ModItem
	{
		...
		{
			// DisplayName.SetDefault("Crimson Pendant"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
			// Tooltip.SetDefault("15% increased ranged velocity\n2% increased ranged crit chance\nRanged crits have a 20% chance to inflict ichor");
		}
