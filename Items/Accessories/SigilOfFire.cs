...
namespace AwfulGarbageMod.Items.Accessories
{
    ...
    public class SigilOfFire : ModItem
	{
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            TooltipLine tooltip;
            tooltip = new TooltipLine(Mod, "tooltipWithoutArgs", tooltipWithoutArgs.Format(Math.Round(2.5f * player.GetModPlayer<GlobalPlayer>().empowermentCooldowMultiplier * 100) / 100));
        ...
        {
			player.GetModPlayer<FireEmpowermentPlayer>().hasSigil = true;
        }
