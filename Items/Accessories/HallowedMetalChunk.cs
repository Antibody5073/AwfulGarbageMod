...
namespace AwfulGarbageMod.Items.Accessories
{
    ...
    public class HallowedMetalChunk : ModItem
	{
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetModPlayer<GlobalPlayer>().EnchantedSword += 50;
        }
	}
    public class HallowedMetalChunkProj : ModProjectile
    {
        Vector2 dashVel;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            float spd = 14;
            int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), pos, (toMouse * spd), ProjectileID.StarVeilStar, Projectile.damage * 2 / 3, Projectile.knockBack / 2, Projectile.owner);
        ...
        private bool CheckActive(Player owner)
        {
            ...
            if (owner.GetModPlayer<GlobalPlayer>().EnchantedSword > 0)
            {
                Projectile.timeLeft = 2;
                Projectile.originalDamage = owner.GetModPlayer<GlobalPlayer>().EnchantedSword;
            }
        ...
        private void GeneralBehavior(Player owner, out Vector2 vectorToIdlePosition, out float distanceToIdlePosition)
        {
            ...
            idlePosition.Y -= 16 * 9f; // Go up 48 coordinates (three tiles from the center of the player)
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, NPC target, float distanceToIdlePosition, Vector2 vectorToIdlePosition)
        {
            ...
            if (foundTarget)
            {
                ...
                else if (!isDashing)
                {
                    ...
                    float extraDir = AGUtils.TurnTowards(0.1f, Vector2.One.RotatedBy(targetDir), origTargetDir, Vector2.Zero) * 900;
                    targetDir += extraDir;
                }
                if (dashCooldown > 0)
                {
            ...
            else
            {
                ...
                dashCooldown -= 1;
                    targetDir = MathHelper.ToRadians(-90);
            }
        }
