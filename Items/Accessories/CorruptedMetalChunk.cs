...
namespace AwfulGarbageMod.Items.Accessories
{
    ...
    public class CorruptedMetalChunk : ModItem
	{
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetModPlayer<GlobalPlayer>().CursedHammer += 50;
        }
	}
    public class CorruptedMetalChunkProj : ModProjectile
    {
        Vector2 dashVel;
        ...
        private bool CheckActive(Player owner)
        {
            ...
            if (owner.GetModPlayer<GlobalPlayer>().CursedHammer > 0)
            {
                Projectile.timeLeft = 2;
                Projectile.originalDamage = owner.GetModPlayer<GlobalPlayer>().CursedHammer;
            }
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, NPC target, float distanceToIdlePosition, Vector2 vectorToIdlePosition)
        {
            ...
            if (foundTarget)
            {
                ...
                else if (!isDashing)
                {
                    ...
                    float extraDir = AGUtils.TurnTowards(0.1f, Vector2.One.RotatedBy(targetDir), origTargetDir, Vector2.Zero) * 450;
                    targetDir += extraDir;
                }
                if (dashCooldown > 0)
                {
