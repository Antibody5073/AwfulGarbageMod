...
namespace AwfulGarbageMod.Items.Accessories
{
    ...
    public class SigilOfVenom : ModItem
	{
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            TooltipLine tooltip;
            tooltip = new TooltipLine(Mod, "tooltipWithoutArgs", tooltipWithoutArgs.Format(Math.Round(1.5f * player.GetModPlayer<GlobalPlayer>().empowermentCooldowMultiplier * 100) / 100));
