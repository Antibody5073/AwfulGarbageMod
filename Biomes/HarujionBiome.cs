...
{
	public class HarujionBiome : ModBiome
	{
		// Select all the scenery
		public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.GetInstance<HarujionBackgroundStyle>();

		// Select Music
		public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/HarujionTheme");
		...
		public override bool IsBiomeActive(Player player) {
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) &&
				...
				ModContent.GetInstance<HarujionTileCount>().lifelessBlockCount >= 100;
		}
