...
namespace AwfulGarbageMod.NPCs
{
	...
	/// </summary>
	public abstract class WormFrigidius : ModNPC
	{
		/*  ai[] usage:
		 *  
	...
	/// </summary>
	public abstract class WormHead : WormFrigidius
	{
	...
	public abstract class WormBody : WormFrigidius
	{
		...
		internal static void CommonAI_BodyTail(WormFrigidius worm) {
			...
			if (following is not null) {
				...
				worm.NPC.alpha = following.alpha;
                worm.NPC.dontTakeDamage = following.dontTakeDamage;


                if (following.type == ModContent.NPCType<FrigidiusHead>())
				{
                    worm.NPC.damage = (int)(following.damage / 1.75);
                }
				else
				{
                    worm.NPC.damage = following.damage;
                }
            }
		}
	}
	...
	public abstract class WormTail : WormFrigidius
	{
