...
using AwfulGarbageMod.Items.Placeable.Boss;

namespace AwfulGarbageMod.Tiles.Boss
{
	...
	public class EyeOfTheStormRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "AwfulGarbageMod/Tiles/Boss/EyeOfTheStormRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "AwfulGarbageMod/Tiles/Boss/RelicPedestal";
