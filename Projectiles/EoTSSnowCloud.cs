...
{
    public class EoTSSnowCloud : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.alpha = (Projectile.timeLeft - 420) * 255 / 30;
                Projectile.hostile = false;
            }
            ...
            if (counter % 7 == 0)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_NaturalSpawn(), Projectile.Bottom, new Vector2(0, 5.5f), Mod.Find<ModProjectile>("EoTSSnow").Type, 17, 0, Main.myPlayer);
            }
            NPC boss = Main.npc[(int)Projectile.ai[0]];
            if (Projectile.timeLeft > 30 && (!boss.active))
            {
