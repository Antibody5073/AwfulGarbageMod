...
namespace AwfulGarbageMod.Projectiles
{
    ...
    public class FlintCore : ModProjectile
    {
        public float dir;
        ...
        public virtual float OrbitDistance => 60;
        public virtual float OrbitSpd => 2f;
        ...
        public virtual void GetOrbitDirection(out float tempdir, out Vector2 targetPos, float spd = 1, float distance = 120)
        {
            ...
            tempdir = MathHelper.ToRadians((player.GetModPlayer<GlobalPlayer>().OrbitalDir * spd) + Projectile.ai[0]);
            targetPos = player.MountedCenter + new Vector2(0, -distance + (float)(Math.Sin(tempdir) * 5)) - new Vector2(Projectile.width / 2, Projectile.height / 2);
        }
        ...
        private bool CheckActive(Player owner)
        {
            ...
            if (owner.GetModPlayer<GlobalPlayer>().EarthenBonus == true)
            {
