...
namespace AwfulGarbageMod.Projectiles
{
    ...
    public class MoltenEyeProj : ModProjectile
    {
        public float dir;
        ...
        public virtual float OffsetDir => 180;
        ...
        public virtual void GetOrbitDirection(out float tempdir, out Vector2 targetPos, float spd = 1, float distance = 120)
        {
            ...
            tempdir = MathHelper.ToRadians((player.GetModPlayer<GlobalPlayer>().OrbitalDir * spd) + Projectile.ai[0] * 360 / player.ownedProjectileCounts[this.Type] + OffsetDir);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D pupil = (Texture2D)ModContent.Request<Texture2D>("AwfulGarbageMod/Projectiles/MoltenEyePupil");
        ...
        public override void AI()
        {
            ...
            if (player.GetModPlayer<GlobalPlayer>().MoltenEyeDmg > 0)
            {
                Shoot();
            }
            Visuals();
        ...
        private bool CheckActive(Player owner)
        {
            ...
            if (owner.GetModPlayer<GlobalPlayer>().MoltenEye == true)
            {
        ...
        public virtual void Shoot()
        {
            ...
            direction.Normalize();
            int proj = Projectile.NewProjectile(Projectile.GetSource_ReleaseEntity(), Projectile.Center, direction.RotatedByRandom(MathHelper.ToRadians(5)) * 11, ProjectileID.Fireball, player.GetModPlayer<GlobalPlayer>().MoltenEyeDmg, 2, Projectile.owner);
